...
>
  Supercharge your <br />
  coding <span className="text-[#6ca0f4;] relative inline-block" style={{ marginLeft: '10px', lineHeight: '1.5' }}>skills</span>
  <span className="font-inter text-[#6ca0f4]">.</span>
</motion.h1>
        ...
        >
          <div className="w-1/2">
            ...
            <p className="text-[14px] leading-[20px] text-[#1a2b3b] font-normal">
              Access a wealth of coding resources and tutorials.
            </p>
          </div>
          <div className="w-1/2">
            <h2 className="flex items-center font-semibold text-[1em] text-[#1a2b3b]">
            ...
            <p className="text-[14px] leading-[20px] text-[#1a2b3b] font-normal">
              Connect with a network of passionate coders and mentors.
            </p>
          </div>
        </motion.div>
          ...
          <div className="flex gap-[15px] mt-8 md:mt-0">
            ...
            >
              <Link
                href="https://github.com/Abdul-Moiz31/Mockoff.git"
                target="_blank"
                className="group rounded-full pl-[8px] min-w-[180px] pr-4 py-2 text-[13px] font-semibold transition-all flex items-center justify-center bg-[#1E2B3A] text-white hover:[linear-gradient(0deg, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0.1)), #0D2247] no-underline flex gap-x-2  active:scale-95 scale-100 duration-75"
                style={{
                  boxShadow:
